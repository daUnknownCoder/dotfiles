    ...
    return Widget.Box({
        ...
        setup: box =>
            box.hook(Hyprland, () => {
                box.toggleClassName(
                    'active',
                    Hyprland.active.workspace.id === index
                );
            }),
        child: Widget.EventBox({
            ...
            setup: eventbox => {
                ...
                eventbox.connect(
                    ...
                    (_w, _c, _x, _y, data) => {
                        dispatch(
                            `movetoworkspacesilent ${index},address:${data.get_text()}`
                        );
                    }
                );
            },
        ...
        attribute: clients => {
            ...
            clients
                ...
                .forEach(c => {
                    ...
                    c.mapped &&
                        fixed.put(Client(c), c.at[0] * SCALE, c.at[1] * SCALE);
                });
