...
export default {
    ...
    desktop: {
        ...
        dock: {
            icon_size: Option(56),
            pinned_apps: Option(
                ['Warp', 'Thorium-browser', 'org.gnome.Nautilus', 'spotify'],
                { scss: 'exclude' }
            ),
        },
    },
    ...
    brightnessctlKBD: 'intel_backlight',
    substitutions: {
        icons: [
            ...
            ['temperature-symbolic', 'sensors-temperature-symbolic'],
            ['', 'desktopconnected'],
            ['com.github.Aylur.ags', 'code'],
